...
hl.bind("SUPER + CONTROL + Print", hl.dsp.exec_cmd(v.ipc .. " scripted-widget screen_recorder all toggle")) -- Запись экрана
...
hl.define_submap("resize", function()
    ...
    hl.bind("SHIFT + down", hl.dsp.window.resize({ x = 0, y = -10, relative = true}), { repeating = true }) -- Расширить вниз
    hl.bind("SHIFT + up", hl.dsp.window.resize({ x = 0, y = 10, relative = true}), { repeating = true }) -- Расширить вверх
    hl.bind("SHIFT + right", hl.dsp.window.resize({ x = 10, y = 0, relative = true}), { repeating = true }) -- Расширить вправо

    hl.bind("SUPER + left", hl.dsp.focus({ direction = "l" })) -- Влево
    hl.bind("SUPER + down", hl.dsp.focus({ direction = "d" })) -- Вниз
    hl.bind("SUPER + up", hl.dsp.focus({ direction = "u" })) -- Вверх
    hl.bind("SUPER + right", hl.dsp.focus({ direction = "r" })) -- Вправо
...
hl.bind("SUPER + up", hl.dsp.focus({ direction = "u" })) -- Вверх
hl.bind("SUPER + right", hl.dsp.focus({ direction = "r" })) -- Вправо
hl.bind("SUPER + TAB", hl.dsp.window.cycle_next()) -- Следующее
...
hl.bind("SUPER + mouse_down", hl.dsp.focus({ workspace = "e-1" }), { submap_universal = true })
hl.bind("SUPER + mouse_up",   hl.dsp.focus({ workspace = "e+1" }), { submap_universal = true })
hl.bind("SUPER + SHIFT + mouse_down", hl.dsp.window.move({ workspace = "e-1" }), { submap_universal = true })
hl.bind("SUPER + SHIFT + mouse_up",   hl.dsp.window.move({ workspace = "e+1" }), { submap_universal = true })
