...
# QOL
export HISTCONTROL=ignoreboth:erasedups # No duplicate lines in history
export HISTSIZE=10000                   # Large memory history
export HISTFILESIZE=20000               # Large file history
