...
" Блок при выходе из режима вставки (обычный режим Vim)
let &t_EI = "\e[2 q"

" Вертикальная линия (beam) при входе в режим вставки
" let &t_SI = "\e[6 q"

" Сброс курсора обратно в beam при полном выходе из Vim в терминал
